...
$sql = "CREATE TABLE IF NOT EXISTS `college`.`Students` (`srn` INT(20) NOT NULL AUTO_INCREMENT , `fname` VARCHAR(50) NOT NULL , `email` VARCHAR(50) NOT NULL , `phone` VARCHAR(50) NOT NULL , `passwd` VARCHAR(255) NOT NULL , `gender` VARCHAR(10) NOT NULL , `sub1` VARCHAR(50) NOT NULL , `sub2` VARCHAR(50) NOT NULL , `sub3` VARCHAR(50) NOT NULL , `sub4` VARCHAR(50) NOT NULL , `sub5` VARCHAR(50) NOT NULL , `tdate` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY (`srn`))";
...
$sql1 = "CREATE TABLE IF NOT EXISTS `college`.`contact` (`srn` INT(20) NOT NULL AUTO_INCREMENT , `fname` VARCHAR(50) NOT NULL , `email` VARCHAR(50) NOT NULL , `sub` VARCHAR(50) NOT NULL , `msg` VARCHAR(500) NOT NULL , `dtime` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY (`srn`))";
